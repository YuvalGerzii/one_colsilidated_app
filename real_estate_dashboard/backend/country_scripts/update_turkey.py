#!/usr/bin/env python3
"""
Weekly Update Script for Turkey

Automatically updates economic data for Turkey.
...
- Stores all data in the database for Turkey
- Logs all operations for monitoring

Usage:
    python3 update_turkey.py
    python3 update_turkey.py --force-refresh  # Force update all
    python3 update_turkey.py --max-age-days 3  # Update if older than 3 days

Manual Run:
    cd /home/user/real_estate_dashboard/backend
    python3 country_scripts/update_turkey.py

Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_turkey.py >> logs/turkey_update.log 2>&1
"""
...
async def main():
    """Update Turkey economic data"""
    parser = argparse.ArgumentParser(description='Update Turkey economic data')
