#!/usr/bin/env python3
"""
Weekly Update Script for Spain

Automatically updates economic data for Spain.
...
- Stores all data in the database for Spain
- Logs all operations for monitoring

Usage:
    python3 update_spain.py
    python3 update_spain.py --force-refresh  # Force update all
    python3 update_spain.py --max-age-days 3  # Update if older than 3 days

Manual Run:
    cd /home/user/real_estate_dashboard/backend
    python3 country_scripts/update_spain.py

Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_spain.py >> logs/spain_update.log 2>&1
"""
...
async def main():
    """Update Spain economic data"""
    parser = argparse.ArgumentParser(description='Update Spain economic data')
