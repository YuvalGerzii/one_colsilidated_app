#!/usr/bin/env python3
"""
Weekly Update Script for United States

Automatically updates economic data for United States.
...
- Stores all data in the database for United States
- Logs all operations for monitoring

Usage:
    python3 update_united_states.py
    python3 update_united_states.py --force-refresh  # Force update all
    python3 update_united_states.py --max-age-days 3  # Update if older than 3 days
...
Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_united_states.py >> logs/united-states_update.log 2>&1
"""
...
async def main():
    """Update United States economic data"""
    parser = argparse.ArgumentParser(description='Update United States economic data')
    ...
    # Create fetcher for United States
