#!/usr/bin/env python3
"""
Weekly Update Script for India

Automatically updates economic data for India.
...
- Stores all data in the database for India
- Logs all operations for monitoring

Usage:
    python3 update_india.py
    python3 update_india.py --force-refresh  # Force update all
    python3 update_india.py --max-age-days 3  # Update if older than 3 days

Manual Run:
    cd /home/user/real_estate_dashboard/backend
    python3 country_scripts/update_india.py

Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_india.py >> logs/india_update.log 2>&1
"""
...
async def main():
    """Update India economic data"""
    parser = argparse.ArgumentParser(description='Update India economic data')
