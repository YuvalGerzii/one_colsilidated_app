#!/usr/bin/env python3
"""
Weekly Update Script for Germany

Automatically updates economic data for Germany.
...
- Stores all data in the database for Germany
- Logs all operations for monitoring

Usage:
    python3 update_germany.py
    python3 update_germany.py --force-refresh  # Force update all
    python3 update_germany.py --max-age-days 3  # Update if older than 3 days

Manual Run:
    cd /home/user/real_estate_dashboard/backend
    python3 country_scripts/update_germany.py

Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_germany.py >> logs/germany_update.log 2>&1
"""
...
async def main():
    """Update Germany economic data"""
    parser = argparse.ArgumentParser(description='Update Germany economic data')
