#!/usr/bin/env python3
"""
Weekly Update Script for Brazil

Automatically updates economic data for Brazil.
...
- Stores all data in the database for Brazil
- Logs all operations for monitoring

Usage:
    python3 update_brazil.py
    python3 update_brazil.py --force-refresh  # Force update all
    python3 update_brazil.py --max-age-days 3  # Update if older than 3 days

Manual Run:
    cd /home/user/real_estate_dashboard/backend
    python3 country_scripts/update_brazil.py

Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_brazil.py >> logs/brazil_update.log 2>&1
"""
...
async def main():
    """Update Brazil economic data"""
    parser = argparse.ArgumentParser(description='Update Brazil economic data')
