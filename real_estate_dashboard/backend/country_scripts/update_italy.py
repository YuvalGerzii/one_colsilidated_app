#!/usr/bin/env python3
"""
Weekly Update Script for Italy

Automatically updates economic data for Italy.
...
- Stores all data in the database for Italy
- Logs all operations for monitoring

Usage:
    python3 update_italy.py
    python3 update_italy.py --force-refresh  # Force update all
    python3 update_italy.py --max-age-days 3  # Update if older than 3 days

Manual Run:
    cd /home/user/real_estate_dashboard/backend
    python3 country_scripts/update_italy.py

Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_italy.py >> logs/italy_update.log 2>&1
"""
...
async def main():
    """Update Italy economic data"""
    parser = argparse.ArgumentParser(description='Update Italy economic data')
