#!/usr/bin/env python3
"""
Weekly Update Script for Poland

Automatically updates economic data for Poland.
...
- Stores all data in the database for Poland
- Logs all operations for monitoring

Usage:
    python3 update_poland.py
    python3 update_poland.py --force-refresh  # Force update all
    python3 update_poland.py --max-age-days 3  # Update if older than 3 days

Manual Run:
    cd /home/user/real_estate_dashboard/backend
    python3 country_scripts/update_poland.py

Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_poland.py >> logs/poland_update.log 2>&1
"""
...
async def main():
    """Update Poland economic data"""
    parser = argparse.ArgumentParser(description='Update Poland economic data')
