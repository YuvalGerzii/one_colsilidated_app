#!/usr/bin/env python3
"""
Weekly Update Script for Netherlands

Automatically updates economic data for Netherlands.
...
- Stores all data in the database for Netherlands
- Logs all operations for monitoring

Usage:
    python3 update_netherlands.py
    python3 update_netherlands.py --force-refresh  # Force update all
    python3 update_netherlands.py --max-age-days 3  # Update if older than 3 days

Manual Run:
    cd /home/user/real_estate_dashboard/backend
    python3 country_scripts/update_netherlands.py

Cron Setup (run every Sunday at 2 AM):
    0 2 * * 0 cd /home/user/real_estate_dashboard/backend && python3 country_scripts/update_netherlands.py >> logs/netherlands_update.log 2>&1
"""
...
async def main():
    """Update Netherlands economic data"""
    parser = argparse.ArgumentParser(description='Update Netherlands economic data')
    ...
    # Create fetcher for Netherlands
