"""add_expanded_market_intelligence_data

Revision ID: e256581b7a09
Revises: 8cc9b37111b7
Create Date: 2025-11-14 14:23:47.125352
...
revision: str = 'e256581b7a09'
down_revision: Union[str, None] = '8cc9b37111b7'
...
def upgrade() -> None:
    ...
    op.drop_index('idx_comp_trans_city', table_name='comp_transactions')
    op.drop_index('idx_comp_trans_date', table_name='comp_transactions')
    op.drop_index('idx_comp_trans_price', table_name='comp_transactions')
    op.drop_index('idx_comp_trans_type', table_name='comp_transactions')
    ...
    op.add_column('properties', sa.Column('company_id', sa.UUID(), nullable=False, comment='Company that owns this property (for multi-tenant isolation)'))
    ...
    op.create_foreign_key(None, 'properties', 'companies', ['company_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    sa.Column('score_value', sa.NUMERIC(precision=5, scale=2), autoincrement=False, nullable=False),
    ...
    sa.Column('city', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('submarket', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('state', sa.VARCHAR(length=50), server_default=sa.text("'NY'::character varying"), autoincrement=False, nullable=True),
    sa.Column('property_type', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('property_class', sa.VARCHAR(length=10), autoincrement=False, nullable=True),
    sa.Column('sale_date', sa.DATE(), autoincrement=False, nullable=False),
    sa.Column('sale_price', sa.NUMERIC(precision=20, scale=2), autoincrement=False, nullable=True),
    sa.Column('price_per_unit', sa.NUMERIC(precision=15, scale=2), autoincrement=False, nullable=True),
    sa.Column('price_per_sf', sa.NUMERIC(precision=15, scale=2), autoincrement=False, nullable=True),
    sa.Column('cap_rate', sa.NUMERIC(precision=5, scale=4), autoincrement=False, nullable=True),
    sa.Column('units', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('total_sf', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('year_built', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('buyer', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('seller', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('financing_type', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('occupancy_at_sale', sa.NUMERIC(precision=5, scale=4), autoincrement=False, nullable=True),
    sa.Column('deal_type', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('data_source', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('source_url', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('notes', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('transaction_id', name='comp_transactions_pkey')
    )
    op.create_index('idx_comp_trans_type', 'comp_transactions', ['property_type', 'property_class'], unique=False)
    op.create_index('idx_comp_trans_price', 'comp_transactions', ['price_per_sf', 'price_per_unit'], unique=False)
    op.create_index('idx_comp_trans_date', 'comp_transactions', ['sale_date'], unique=False)
    op.create_index('idx_comp_trans_city', 'comp_transactions', ['city'], unique=False)
