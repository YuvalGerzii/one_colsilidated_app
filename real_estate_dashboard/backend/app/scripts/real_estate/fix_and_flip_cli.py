...
def build_chart_specs(results: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    cash_invested = results["cash_invested"]

    # Cash flow waterfall data
    arv = results.get("arv", total_cost + gross_profit)
    selling_costs = results.get("selling_costs", arv * 0.07)
    ...
    return [
        ...
        },
        {
            "key": "scenario_profit",
            "type": "bar",
            "title": "Exit Scenario Profit Comparison",
        ...
        },
        {
            "key": "scenario_roi",
            "type": "bar",
            "title": "ROI by Exit Scenario",
            "filename": "scenario_roi.png",
            "labels": [row["label"] for row in results["scenario_rows"]],
            "datasets": [
                {
                    "label": "ROI (%)",
                    "data": [row["roi"] * 100 for row in results["scenario_rows"]],
                    "backgroundColor": ["#FF6B6B", "#4ECDC4", "#45B7D1"],
                }
            ],
            "x_label": "Scenario",
        ...
        },
        {
            "key": "timeline",
            "type": "line",
            "title": "Cumulative Project Spend Over Time",
        ...
        {
            "key": "cash_invested_breakdown",
            "type": "pie",
            "title": "Cash Invested Breakdown",
            "filename": "cash_invested_breakdown.png",
            "labels": ["Down Payment", "Closing Costs", "Repair Costs", "Points Cost", "Holding Costs"],
            "datasets": [
                {
                    "label": "Investment",
                    "data": [
                        results["down_payment"],
                        results.get("closing_costs", 0),
                        results.get("repair_costs", 0),
                        results["points_cost"],
                        results.get("holding_costs", 0),
                    ],
                    "backgroundColor": [
                        "#FF6384",
                        "#36A2EB",
        ...
        {
            "key": "profit_waterfall",
            "type": "bar",
            "title": "Deal Profit Waterfall Analysis",
            "filename": "profit_waterfall.png",
            "labels": ["ARV", "Selling Costs", "Total Cost", "Net Profit"],
            "datasets": [
                {
                    "label": "Amount ($)",
                    "data": [arv, -selling_costs, -total_cost, gross_profit],
                    "backgroundColor": ["#4ECDC4", "#FF6B6B", "#FF6B6B", "#95E1D3"],
                }
            ],
            "x_label": "Stage",
            "y_label": "Amount ($)",
        },
        {
            ...
            "filename": "roi_metrics.png",
            "labels": ["ROI", "Profit Margin", "Return on Cost"],
            "datasets": [
                {
                    "label": "Percentage (%)",
                    "data": [
                        results["roi"] * 100,
                        results["profit_margin"] * 100,
                        results["return_on_cost"] * 100,
                    ],
                    "backgroundColor": ["#4ECDC4", "#95E1D3", "#45B7D1"],
                }
            ],
            "x_label": "Metric",
            "y_label": "Percentage (%)",
