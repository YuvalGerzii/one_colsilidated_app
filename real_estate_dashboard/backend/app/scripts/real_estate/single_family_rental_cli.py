...
def build_chart_specs(
    ...
    rent_values = [projection["gross_rent"] for projection in projections]
    expense_values = [projection["operating_expenses"] for projection in projections]
    equity_values = [projection["equity"] for projection in projections]
    property_values = [projection["property_value"] for projection in projections]
    loan_balances = [projection["loan_balance"] for projection in projections]

    # Calculate Cash-on-Cash returns for each year
    coc_returns = [
        (projection["cash_flow"] / inputs["equity_invested"] * 100) if inputs["equity_invested"] > 0 else 0
        for projection in projections
    ]

    # Calculate Cap Rates for each year
    cap_rates = [
        (projection["noi"] / projection["property_value"] * 100) if projection["property_value"] > 0 else 0
        for projection in projections
    ]
    ...
    return [
        {
            ...
            "datasets": [
                ...
                {
                    "label": "Debt Service ($)",
                    "data": [projection["debt_service"] for projection in projections],
                    "borderColor": "#FF6B6B",
            ...
            "datasets": [
                {
                    ...
                    "data": metrics["cumulative_cash_flows"],
                    "borderColor": "#36A2EB",
        ...
        },
        {
            "key": "rent_growth",
            "type": "line",
            "title": "Rental Income Growth Over Time",
            "filename": "rent_growth.png",
            "labels": years,
            "datasets": [
                {
                    "label": "Gross Rent ($)",
        ...
        },
        {
            ...
            "filename": "operating_expenses.png",
            "labels": years,
            "datasets": [
                {
            ...
            "x_label": "Year",
            "y_label": "Annual Expenses ($)",
        },
        {
            "key": "coc_return",
            "type": "bar",
            "title": "Cash-on-Cash Return by Year",
            "filename": "coc_return.png",
            "labels": years,
            "datasets": [
                {
                    "label": "CoC Return (%)",
        ...
        },
        {
            "key": "cap_rate",
            "type": "line",
            "title": "Cap Rate Progression",
            "filename": "cap_rate.png",
            "labels": years,
            "datasets": [
                {
                    "label": "Cap Rate (%)",
        ...
        },
        {
            ...
            "type": "bar",
            "title": "Year 1 Income vs Expenses Breakdown",
            "filename": "income_vs_expenses.png",
            "labels": ["Gross Rent", "Vacancy Loss", "Operating Expenses", "Debt Service", "Cash Flow"],
            "datasets": [
                {
                    "label": "Amount ($)",
                    "data": [
                        projections[0]["gross_rent"],
                        -projections[0]["vacancy"],
                        -projections[0]["operating_expenses"],
                        -projections[0]["debt_service"],
                        projections[0]["cash_flow"],
                    ],
                    "backgroundColor": ["#4ECDC4", "#FF6B6B", "#FFCE56", "#FF8C42", "#95E1D3"],
                }
            ],
            "x_label": "Category",
            "y_label": "Amount ($)",
