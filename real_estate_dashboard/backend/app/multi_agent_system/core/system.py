...
from app.multi_agent_system.core.types import Task, Result, SystemMetrics
...
from app.multi_agent_system.agents.workers import create_worker_pool
from app.multi_agent_system.communication.message_bus import MessageBus
from app.multi_agent_system.memory.memory_manager import MemoryManager
from app.multi_agent_system.learning.q_learning import QLearningEngine
from app.multi_agent_system.tools.base_tool import ToolRegistry
...
class MultiAgentSystem:
    ...
    def add_agent(
        ...
        Returns:
            Agent ID
        """
        from app.multi_agent_system.core.types import AgentCapability
        from app.multi_agent_system.agents.workers import GeneralAgent
