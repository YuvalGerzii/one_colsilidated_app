...
echo "  - Real Estate:       http://localhost:3003"
echo "  - Bond.AI:           http://localhost:3004"
echo "  - Labor:             http://localhost:3005"
echo ""
echo "APIs:"
echo "  - Finance API:       http://localhost:8000"
echo "  - Real Estate API:   http://localhost:8001"
echo "  - Bond.AI API:       http://localhost:8002"
echo "  - Legacy API:        http://localhost:8003"
echo "  - Labor API:         http://localhost:8004"
echo ""
