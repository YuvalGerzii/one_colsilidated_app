    ...
    return [
        {
            ...
            "labels": years,
            "datasets": {
                "Total Revenue": [projection["total_revenue"] for projection in projections],
                "Total Expenses": [projection["total_expenses"] for projection in projections],
        ...
        },
        {
            ...
            "datasets": {
                ...
                "Cumulative Cash Flow": summary["cumulative_cash_flows"],
            },
            "x_label": "Year",
            "y_label": "Amount ($)",
        },
        {
            ...
            "labels": years,
            "datasets": {
                "Occupancy %": [projection["occupancy"] * 100 for projection in projections],
                "ADR": [projection["adr"] for projection in projections],
            },
            "x_label": "Year",
            "y_label": "Value",
        },
