"""
Portfolio Dashboard Backend - Main Application
...
app = FastAPI(
    ...
    description="Complete backend API for Portfolio Company Dashboard",
...
async def print_startup_info():
    ...
    if settings.DEBUG:
        print("\n" + "="*60)
        print(f"Portfolio Dashboard API v{settings.APP_VERSION}")
        print("="*60)
